...
import { ArrowUpRight, Phone, Calendar, CheckCircle } from 'lucide-react'
    ...
    <div className="bg-white">
      ...
      >
        ...
        >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mt-8 mb-8 justify-items-center lg:justify-items-start">
