...
export interface DoctorDetail {
  ...
  specialty: string
  image: string
  /** Side-view image shown on hover (optional; e.g. Dr. Nasrin has no side view) */
  imageSide?: string
  aboutImage: string
  description: string
  stats: {
...
export const doctorsData: DoctorDetail[] = [
  ...
  },
  {
    ...
    imageSide: drMuhammadAbdulrazakSideImg,
